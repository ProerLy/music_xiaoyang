<template>
    <!-- 轮播图 -->
    <el-carousel @change="auto" :style="'background-image:url(' + carousel.arr[backIndex]?.baner_img + ');'" trigger="click"
                    ...
                    <div class="cont_box">
                        <div class="title_list">
                            ...
                            <div class="title">
                                <el-icon color="red">
                                    <Aim />
                                </el-icon><span>热门推荐</span>
                                <!-- 热门推荐列表分类 -->
                                <el-breadcrumb separator="|">
                                    <el-breadcrumb-item v-for="it in 8" :key="it"><el-link :underline="false"
                                            ...
                                            <div class="control">
                                                ...
                                                <span>
                                                    <el-icon :style="music_id == it?.music_id ? 'color: red;' : ''"
                                                        @click="play_add(it?.music_id, null, null, 'play')" class="icon"
                                                        title="播放">
                                                        <VideoPlay />
                                                    </el-icon>
                                                </span>
                                    ...
                                    <ul class="top_list">
                                        ...
                                        <li style="text-align: right;">
                                            <el-link @click="$router.push('/find/toplist/' + it.id)"
                                                type=danger>查看全部<el-icon color="red">
                                                    <DArrowRight />
                                                </el-icon></el-link>
                                        </li>
                                    </ul>
    ...
    <collectNav @close="close" :isCollectSongList="isCollectSongList" :songid="songid" :table="table" :listid="toplistid" />
</template>
<script>
export default {
    name: 'TuiJian'
...
import { getData as _getdtl, downLoad } from '../../func/index.js'
