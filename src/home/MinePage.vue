        ...
        <el-skeleton :loading="loading" animated>
            ...
            <template #template>
                <el-row :gutter="20">
                    ...
                    <el-col :span="17" :offset="1">
                        ...
                        <div style="width: 100%;">
                            <el-skeleton-item variant="text" style="width: 40%;" /><br>
                            <el-skeleton-item variant="text" style="width: 30%" /><br>
                ...
                <br>
                <br>
                <el-skeleton-item variant="h1" style="width: 20%; height: 30px;"></el-skeleton-item>
                <el-skeleton-item variant="p" style="height: 2px;"></el-skeleton-item>
                <el-skeleton-item variant="p" style="height: 30px;"></el-skeleton-item>
                <br>
                <br>
                <el-skeleton-item variant="h1" style="width: 20%;"></el-skeleton-item>
                <el-skeleton-item variant="p" style="height: 2px;"></el-skeleton-item>
                <el-row :gutter="20">
                    <el-col :span="6" :offset="0" v-for="it in 4" :key="it">
                        <el-skeleton-item variant="image" style="width: 140px; height: 140px" />
                        <el-skeleton-item variant="text" style="width: 70px;"></el-skeleton-item>
                    </el-col>
                </el-row>
            </template>
            <!-- 内容 -->
            <template #default>
                ...
                <div id="histroySongList">
                    <h3 class="songListTitle">听过的歌曲 <small>累计听歌{{ histroy.total }}首</small></h3>
                ...
                <div id="collectSongList">
                    <h3 class="songListTitle">我的收藏歌单({{ collectSongList.total }})</h3>
                    <div class="songList" v-if="!collectSongList.total">
                        <el-empty description="暂无歌单" />
                    </div>
                    <div v-else class="songList">
                        <el-row :gutter="20">
                            <el-col :xl="{ span: 6 }" :lg="{ span: 6 }" :md="{ span: 6 }" :sm="{ span: 12 }"
                                :xs="{ span: 12 }" style="margin: 10px 0;" :span="6" :offset="0"
                                v-for="(it, index) in collectSongList.info" :key="index">
                                <div style="width: 140px; height: 140px; position: relative;">
                                    <el-link :title="it?.type_name" :underline="false"
                                        @click="$router.push('/mymusic/' + it?.id)"><el-image
                                            style="width: 140px; height: 140px; " :src="it?.banner_img"
                                            fit="fit" /></el-link>
                                    <p class="listControl">
                                        <span title="歌曲数量">
                                            <el-icon>
                                        ...
                                        <span>
                                            <el-icon title="播放" class="icon"
                                                @click="play_add(null, it?.id, 'collect', 'play')">
                                                <VideoPlay />
                                            </el-icon>
                                        </span>
                                    </p>
                                </div>
                                <el-link @click="$router.push('/mymusic/' + it?.id)" :title="it?.type_name" type="danger"
...
// 确定删除
const del_ok = () => {
    proxy.$axios.post('/delet_history.php',
        Qs.stringify({
