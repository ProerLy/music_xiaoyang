<template>
  ...
  <el-menu id="menu" background-color="#242424" class="el-menu-demo" text-color="#E5EAF3" active-text-color="#ffffff"
    ...
    <!-- logo -->
    <div id="logo">
      <router-link to="/home">七语熙音乐馆</router-link>
    </div>
    ...
    <div class="sys_msg">
      <div id="box">
        <p id="tip">
          ...
          <span v-for=" it in msg" :key="it?.id">{{ it?.content }}</span></p>
      </div>
    </div>
    <div class="flex-grow"/>
    <!-- 搜索框 -->
    ...
    <div class="msg">
      <template v-if="msg_num != 0 && !!msg_num">
        <el-badge :value="msg_num" class="item">
          <el-button size="mini" round @click="$router.push('/msg')">
            <el-icon>
              <Message/>
            </el-icon>
            消息
    ...
    <div class="avatar">
      <div class="flex flex-wrap items-center" v-if="!!nowUser">
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="mineHome()">
                <el-icon>
                  <Avatar/>
                </el-icon>
                我的主页
              </el-dropdown-item>
              <el-dropdown-item @click="mineOwn()">
                <el-icon>
                  <Postcard/>
                </el-icon>
                个人设置
              </el-dropdown-item>
              <el-dropdown-item @click="table = true">
                <el-icon>
                  <Tools/>
                </el-icon>
                设置
  ...
  <el-drawer v-model="table" direction="rtl" size="50%">
    ...
    <div id="style">
      <el-divider border-style="double">
        <el-tag type="success" :size="large" effect="plain">主题</el-tag>
      </el-divider>
      <div>
